// Generated from definition com.github.openshift.api.quota.v1.AppliedClusterResourceQuota
...
// Begin quota.openshift.io/v1/AppliedClusterResourceQuota

// Generated from operation listQuotaOpenshiftIoV1AppliedClusterResourceQuotaForAllNamespaces
...
impl AppliedClusterResourceQuota {
    ...
    pub fn list_applied_cluster_resource_quota_for_all_namespaces(
        ...
        let __url = "/apis/quota.openshift.io/v1/appliedclusterresourcequotas?".to_owned();
...
// Generated from operation listQuotaOpenshiftIoV1NamespacedAppliedClusterResourceQuota
...
impl AppliedClusterResourceQuota {
    ...
    pub fn list_namespaced_applied_cluster_resource_quota(
        ...
        let __url = format!("/apis/quota.openshift.io/v1/namespaces/{namespace}/appliedclusterresourcequotas?",
...
// Generated from operation readQuotaOpenshiftIoV1NamespacedAppliedClusterResourceQuota
...
impl AppliedClusterResourceQuota {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadNamespacedAppliedClusterResourceQuotaResponse>), k8s_openapi::RequestError> {
        let ReadNamespacedAppliedClusterResourceQuotaOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/quota.openshift.io/v1/namespaces/{namespace}/appliedclusterresourcequotas/{name}?",
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadNamespacedAppliedClusterResourceQuotaResponse {
    Ok(crate::api::quota::v1::AppliedClusterResourceQuota),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadNamespacedAppliedClusterResourceQuotaResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), k8s_openapi::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((ReadNamespacedAppliedClusterResourceQuotaResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadNamespacedAppliedClusterResourceQuotaResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation watchQuotaOpenshiftIoV1AppliedClusterResourceQuotaForAllNamespaces
...
// Generated from operation watchQuotaOpenshiftIoV1NamespacedAppliedClusterResourceQuota
...
// End quota.openshift.io/v1/AppliedClusterResourceQuota

impl k8s_openapi::Resource for AppliedClusterResourceQuota {
    const API_VERSION: &'static str = "quota.openshift.io/v1";
    const GROUP: &'static str = "quota.openshift.io";
    const KIND: &'static str = "AppliedClusterResourceQuota";
    const VERSION: &'static str = "v1";
    // fixed `Resource` impl
    const URL_PATH_SEGMENT: &'static str = "appliedclusterresourcequotas";
    type Scope = k8s_openapi::NamespaceResourceScope;
}

impl k8s_openapi::ListableResource for AppliedClusterResourceQuota {
    const LIST_KIND: &'static str = concat!("AppliedClusterResourceQuota", "List");
}
...
impl<'de> serde::Deserialize<'de> for AppliedClusterResourceQuota {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = AppliedClusterResourceQuota;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                Ok(AppliedClusterResourceQuota {
...
impl serde::Serialize for AppliedClusterResourceQuota {
