// Generated from definition com.github.openshift.api.authorization.v1.SubjectRulesReview

/// SubjectRulesReview is a resource you can create to determine which actions another user can perform in a namespace
#[derive(Clone, Debug, Default, PartialEq)]
pub struct SubjectRulesReview {
    /// Spec adds information about how to conduct the check
    pub spec: crate::api::authorization::v1::SubjectRulesReviewSpec,
...
// Begin authorization.openshift.io/v1/SubjectRulesReview

// Generated from operation createAuthorizationOpenshiftIoV1NamespacedSubjectRulesReview
...
impl SubjectRulesReview {
    ...
    #[cfg(feature = "api")]
    pub fn create_namespaced_subject_rules_review(
        namespace: &str,
        body: &crate::api::authorization::v1::SubjectRulesReview,
        ...
        let __url = format!("/apis/authorization.openshift.io/v1/namespaces/{namespace}/subjectrulesreviews?",
...
// End authorization.openshift.io/v1/SubjectRulesReview

impl k8s_openapi::Resource for SubjectRulesReview {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_spec: Option<crate::api::authorization::v1::SubjectRulesReviewSpec> = None;
...
impl serde::Serialize for SubjectRulesReview {
