// Generated from definition com.github.openshift.api.authorization.v1.ClusterRoleBinding
...
// Begin authorization.openshift.io/v1/ClusterRoleBinding

// Generated from operation createAuthorizationOpenshiftIoV1ClusterRoleBinding
...
impl ClusterRoleBinding {
    ...
    pub fn create_cluster_role_binding(
        body: &crate::api::authorization::v1::ClusterRoleBinding,
    ...
    > {
        let __url = "/apis/authorization.openshift.io/v1/clusterrolebindings?".to_owned();
...
// Generated from operation deleteAuthorizationOpenshiftIoV1ClusterRoleBinding
...
// Generated from operation listAuthorizationOpenshiftIoV1ClusterRoleBinding
...
// Generated from operation patchAuthorizationOpenshiftIoV1ClusterRoleBinding
...
// Generated from operation readAuthorizationOpenshiftIoV1ClusterRoleBinding
...
impl ClusterRoleBinding {
    ...
    pub fn read_cluster_role_binding(
        ...
        (
            http::Request<Vec<u8>>,
            fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadClusterRoleBindingResponse>,
        ),
        k8s_openapi::RequestError,
    > {
        let ReadClusterRoleBindingOptional { pretty } = optional;
        let __url = format!(
            "/apis/authorization.openshift.io/v1/clusterrolebindings/{name}?",
            name = k8s_openapi::percent_encoding::percent_encode(
                name.as_bytes(),
...
pub enum ReadClusterRoleBindingResponse {
    Ok(crate::api::authorization::v1::ClusterRoleBinding),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadClusterRoleBindingResponse {
    fn try_from_parts(
...
// Generated from operation replaceAuthorizationOpenshiftIoV1ClusterRoleBinding
...
// Generated from operation watchAuthorizationOpenshiftIoV1ClusterRoleBinding
...
// End authorization.openshift.io/v1/ClusterRoleBinding

impl k8s_openapi::Resource for ClusterRoleBinding {
...
impl k8s_openapi::ListableResource for ClusterRoleBinding {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
                ...
                A: serde::de::MapAccess<'de>,
            {
                ...
                let mut value_subjects: Option<Vec<k8s_openapi::api::core::v1::ObjectReference>> =
                    None;
                ...
                while let Some(key) = serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_group_names => {
                            value_group_names = Some(serde::de::MapAccess::next_value(&mut map)?)
                        }
                        Field::Key_metadata => {
                            value_metadata = Some(serde::de::MapAccess::next_value(&mut map)?)
                        }
                        Field::Key_role_ref => {
                            value_role_ref = Some(serde::de::MapAccess::next_value(&mut map)?)
                        }
                        Field::Key_subjects => {
                            value_subjects = Some(serde::de::MapAccess::next_value(&mut map)?)
                        }
                        Field::Key_user_names => {
                            value_user_names = Some(serde::de::MapAccess::next_value(&mut map)?)
                        }
                        Field::Other => {
                ...
                Ok(ClusterRoleBinding {
                    group_names: value_group_names
                        .ok_or_else(|| serde::de::Error::missing_field("groupNames"))?,
                    metadata: value_metadata
                        .ok_or_else(|| serde::de::Error::missing_field("metadata"))?,
                    role_ref: value_role_ref
                        .ok_or_else(|| serde::de::Error::missing_field("roleRef"))?,
                    subjects: value_subjects
                        .ok_or_else(|| serde::de::Error::missing_field("subjects"))?,
                    user_names: value_user_names
...
impl serde::Serialize for ClusterRoleBinding {
    ...
    where
        S: serde::Serializer,
    {
        let mut state = serializer.serialize_struct(<Self as k8s_openapi::Resource>::KIND, 7)?;
