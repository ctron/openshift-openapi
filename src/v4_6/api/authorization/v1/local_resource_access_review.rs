// Generated from definition com.github.openshift.api.authorization.v1.LocalResourceAccessReview
...
// Begin authorization.openshift.io/v1/LocalResourceAccessReview

// Generated from operation createAuthorizationOpenshiftIoV1NamespacedLocalResourceAccessReview
...
impl LocalResourceAccessReview {
    ...
    pub fn create_namespaced_local_resource_access_review(
        namespace: &str,
        body: &crate::api::authorization::v1::LocalResourceAccessReview,
    ...
    > {
        let __url = format!("/apis/authorization.openshift.io/v1/namespaces/{namespace}/localresourceaccessreviews?",
...
// End authorization.openshift.io/v1/LocalResourceAccessReview

impl k8s_openapi::Resource for LocalResourceAccessReview {
    const API_VERSION: &'static str = "authorization.openshift.io/v1";
    const GROUP: &'static str = "authorization.openshift.io";
    const KIND: &'static str = "LocalResourceAccessReview";
    const VERSION: &'static str = "v1";
    // fixed `Resource` impl
    const URL_PATH_SEGMENT: &'static str = "localresourceaccessreviews";
    type Scope = k8s_openapi::NamespaceResourceScope;
}

impl<'de> serde::Deserialize<'de> for LocalResourceAccessReview {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = LocalResourceAccessReview;
...
impl serde::Serialize for LocalResourceAccessReview {
