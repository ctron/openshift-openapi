// Generated from definition com.github.openshift.api.oauth.v1.OAuthClientAuthorization
...
// Begin oauth.openshift.io/v1/OAuthClientAuthorization

// Generated from operation createOauthOpenshiftIoV1OAuthClientAuthorization
...
impl OAuthClientAuthorization {
    ...
    #[cfg(feature = "api")]
    pub fn create_o_auth_client_authorization(
        body: &crate::api::oauth::v1::OAuthClientAuthorization,
        ...
        let __url = "/apis/oauth.openshift.io/v1/oauthclientauthorizations?".to_owned();
...
// Generated from operation deleteOauthOpenshiftIoV1CollectionOAuthClientAuthorization
...
impl OAuthClientAuthorization {
    ...
    #[cfg(feature = "api")]
    pub fn delete_collection_o_auth_client_authorization(
...
// Generated from operation deleteOauthOpenshiftIoV1OAuthClientAuthorization
...
impl OAuthClientAuthorization {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn delete_o_auth_client_authorization(
        name: &str,
        ...
        let __url = format!("/apis/oauth.openshift.io/v1/oauthclientauthorizations/{name}",
...
// Generated from operation listOauthOpenshiftIoV1OAuthClientAuthorization
...
impl OAuthClientAuthorization {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn list_o_auth_client_authorization(
...
// Generated from operation patchOauthOpenshiftIoV1OAuthClientAuthorization
...
impl OAuthClientAuthorization {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn patch_o_auth_client_authorization(
        name: &str,
...
// Generated from operation readOauthOpenshiftIoV1OAuthClientAuthorization

impl OAuthClientAuthorization {
    /// read the specified OAuthClientAuthorization
    ///
    /// Use the returned [`k8s_openapi::ResponseBody`]`<`[`ReadOAuthClientAuthorizationResponse`]`>` constructor, or [`ReadOAuthClientAuthorizationResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn read_o_auth_client_authorization(
        name: &str,
        optional: ReadOAuthClientAuthorizationOptional<'_>,
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadOAuthClientAuthorizationResponse>), k8s_openapi::RequestError> {
        let ReadOAuthClientAuthorizationOptional {
            exact,
            export,
            pretty,
        } = optional;
...
pub struct ReadOAuthClientAuthorizationOptional<'a> {
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadOAuthClientAuthorizationResponse {
    Ok(crate::api::oauth::v1::OAuthClientAuthorization),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadOAuthClientAuthorizationResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), k8s_openapi::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((ReadOAuthClientAuthorizationResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadOAuthClientAuthorizationResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceOauthOpenshiftIoV1OAuthClientAuthorization
...
impl OAuthClientAuthorization {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn replace_o_auth_client_authorization(
        name: &str,
        body: &crate::api::oauth::v1::OAuthClientAuthorization,
...
// Generated from operation watchOauthOpenshiftIoV1OAuthClientAuthorization
...
impl OAuthClientAuthorization {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn watch_o_auth_client_authorization(
...
// End oauth.openshift.io/v1/OAuthClientAuthorization

impl k8s_openapi::Resource for OAuthClientAuthorization {
    const API_VERSION: &'static str = "oauth.openshift.io/v1";
    const GROUP: &'static str = "oauth.openshift.io";
    const KIND: &'static str = "OAuthClientAuthorization";
    const VERSION: &'static str = "v1";
    // fixed `Resource` impl
    const URL_PATH_SEGMENT: &'static str = "oauthclientauthorizations";
    type Scope = k8s_openapi::ClusterResourceScope;
}

impl k8s_openapi::ListableResource for OAuthClientAuthorization {
    const LIST_KIND: &'static str = concat!("OAuthClientAuthorization", "List");
}
...
impl<'de> serde::Deserialize<'de> for OAuthClientAuthorization {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = OAuthClientAuthorization;
...
impl serde::Serialize for OAuthClientAuthorization {
