// Generated from definition com.github.openshift.api.security.v1.PodSecurityPolicySubjectReviewStatus
...
impl<'de> serde::Deserialize<'de> for PodSecurityPolicySubjectReviewStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = PodSecurityPolicySubjectReviewStatus;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("PodSecurityPolicySubjectReviewStatus")
            }
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                Ok(PodSecurityPolicySubjectReviewStatus {
...
impl serde::Serialize for PodSecurityPolicySubjectReviewStatus {
