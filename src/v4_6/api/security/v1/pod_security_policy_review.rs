// Generated from definition com.github.openshift.api.security.v1.PodSecurityPolicyReview

/// PodSecurityPolicyReview checks which service accounts (not users, since that would be cluster-wide) can create the `PodTemplateSpec` in question.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct PodSecurityPolicyReview {
    /// spec is the PodSecurityPolicy to check.
    pub spec: crate::api::security::v1::PodSecurityPolicyReviewSpec,

    /// status represents the current information/status for the PodSecurityPolicyReview.
    pub status: Option<crate::api::security::v1::PodSecurityPolicyReviewStatus>,
}

// Begin security.openshift.io/v1/PodSecurityPolicyReview

// Generated from operation createSecurityOpenshiftIoV1NamespacedPodSecurityPolicyReview
...
impl PodSecurityPolicyReview {
    ...
    #[cfg(feature = "api")]
    pub fn create_namespaced_pod_security_policy_review(
        namespace: &str,
        body: &crate::api::security::v1::PodSecurityPolicyReview,
        ...
        let __url = format!("/apis/security.openshift.io/v1/namespaces/{namespace}/podsecuritypolicyreviews?",
...
// End security.openshift.io/v1/PodSecurityPolicyReview

impl k8s_openapi::Resource for PodSecurityPolicyReview {
    const API_VERSION: &'static str = "security.openshift.io/v1";
    const GROUP: &'static str = "security.openshift.io";
    const KIND: &'static str = "PodSecurityPolicyReview";
    const VERSION: &'static str = "v1";
    // fixed `Resource` impl
    const URL_PATH_SEGMENT: &'static str = "podsecuritypolicyreviews";
    type Scope = k8s_openapi::NamespaceResourceScope;
}

impl<'de> serde::Deserialize<'de> for PodSecurityPolicyReview {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = PodSecurityPolicyReview;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_spec: Option<crate::api::security::v1::PodSecurityPolicyReviewSpec> = None;
                let mut value_status: Option<crate::api::security::v1::PodSecurityPolicyReviewStatus> = None;
...
impl serde::Serialize for PodSecurityPolicyReview {
