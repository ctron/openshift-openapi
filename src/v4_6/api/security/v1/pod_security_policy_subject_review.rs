// Generated from definition com.github.openshift.api.security.v1.PodSecurityPolicySubjectReview
...
pub struct PodSecurityPolicySubjectReview {
    ...
    pub spec: crate::api::security::v1::PodSecurityPolicySubjectReviewSpec,

    /// status represents the current information/status for the PodSecurityPolicySubjectReview.
    pub status: Option<crate::api::security::v1::PodSecurityPolicySubjectReviewStatus>,
}

// Begin security.openshift.io/v1/PodSecurityPolicySubjectReview

// Generated from operation createSecurityOpenshiftIoV1NamespacedPodSecurityPolicySubjectReview
...
impl PodSecurityPolicySubjectReview {
    ...
    #[cfg(feature = "api")]
    pub fn create_namespaced_pod_security_policy_subject_review(
        namespace: &str,
        body: &crate::api::security::v1::PodSecurityPolicySubjectReview,
        ...
        let __url = format!("/apis/security.openshift.io/v1/namespaces/{namespace}/podsecuritypolicysubjectreviews?",
...
// End security.openshift.io/v1/PodSecurityPolicySubjectReview

impl k8s_openapi::Resource for PodSecurityPolicySubjectReview {
    const API_VERSION: &'static str = "security.openshift.io/v1";
    const GROUP: &'static str = "security.openshift.io";
    const KIND: &'static str = "PodSecurityPolicySubjectReview";
    const VERSION: &'static str = "v1";
}

impl<'de> serde::Deserialize<'de> for PodSecurityPolicySubjectReview {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = PodSecurityPolicySubjectReview;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_spec: Option<crate::api::security::v1::PodSecurityPolicySubjectReviewSpec> = None;
                let mut value_status: Option<crate::api::security::v1::PodSecurityPolicySubjectReviewStatus> = None;
                ...
                Ok(PodSecurityPolicySubjectReview {
...
impl serde::Serialize for PodSecurityPolicySubjectReview {
