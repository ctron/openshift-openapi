// Generated from definition com.github.openshift.api.network.v1.NetNamespace
...
// Begin network.openshift.io/v1/NetNamespace

// Generated from operation createNetworkOpenshiftIoV1NetNamespace
...
impl NetNamespace {
    ...
    pub fn create_net_namespace(
        body: &crate::api::network::v1::NetNamespace,
        ...
        let __url = "/apis/network.openshift.io/v1/netnamespaces?".to_owned();
...
// Generated from operation deleteNetworkOpenshiftIoV1CollectionNetNamespace
...
// Generated from operation deleteNetworkOpenshiftIoV1NetNamespace
...
impl NetNamespace {
    ...
    pub fn delete_net_namespace(
        ...
        let __url = format!("/apis/network.openshift.io/v1/netnamespaces/{name}",
...
// Generated from operation listNetworkOpenshiftIoV1NetNamespace
...
// Generated from operation patchNetworkOpenshiftIoV1NetNamespace
...
// Generated from operation readNetworkOpenshiftIoV1NetNamespace
...
impl NetNamespace {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadNetNamespaceResponse>), k8s_openapi::RequestError> {
        let ReadNetNamespaceOptional {
            exact,
            export,
            pretty,
        } = optional;
...
pub struct ReadNetNamespaceOptional<'a> {
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadNetNamespaceResponse {
    Ok(crate::api::network::v1::NetNamespace),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadNetNamespaceResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), k8s_openapi::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((ReadNetNamespaceResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadNetNamespaceResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceNetworkOpenshiftIoV1NetNamespace
...
// Generated from operation watchNetworkOpenshiftIoV1NetNamespace
...
// End network.openshift.io/v1/NetNamespace

impl k8s_openapi::Resource for NetNamespace {
    ...
    // fixed `Resource` impl
    const URL_PATH_SEGMENT: &'static str = "netnamespaces";
    type Scope = k8s_openapi::ClusterResourceScope;
}

impl k8s_openapi::ListableResource for NetNamespace {
    const LIST_KIND: &'static str = concat!("NetNamespace", "List");
}
...
impl<'de> serde::Deserialize<'de> for NetNamespace {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: serde::de::Error {
                        Ok(match v {
                            ...
                            "netid" => Field::Key_netid,
                            "netname" => Field::Key_netname,
                            _ => Field::Other,
                        })
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_netid: Option<i64> = None;
                let mut value_netname: Option<String> = None;
...
impl serde::Serialize for NetNamespace {
