// Generated from definition com.github.openshift.api.build.v1.BitbucketWebHookCause

/// BitbucketWebHookCause has information about a Bitbucket webhook that triggered a build.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct BitbucketWebHookCause {
...
impl<'de> serde::Deserialize<'de> for BitbucketWebHookCause {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = BitbucketWebHookCause;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("BitbucketWebHookCause")
            }
...
impl serde::Serialize for BitbucketWebHookCause {
