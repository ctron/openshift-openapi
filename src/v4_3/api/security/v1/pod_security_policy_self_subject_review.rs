// Generated from definition com.github.openshift.api.security.v1.PodSecurityPolicySelfSubjectReview
...
pub struct PodSecurityPolicySelfSubjectReview {
    ...
    pub spec: crate::api::security::v1::PodSecurityPolicySelfSubjectReviewSpec,
...
// Begin security.openshift.io/v1/PodSecurityPolicySelfSubjectReview

// Generated from operation createSecurityOpenshiftIoV1NamespacedPodSecurityPolicySelfSubjectReview
...
impl PodSecurityPolicySelfSubjectReview {
    ...
    pub fn create_namespaced_pod_security_policy_self_subject_review(
        namespace: &str,
        body: &crate::api::security::v1::PodSecurityPolicySelfSubjectReview,
        ...
        let __url = format!("/apis/security.openshift.io/v1/namespaces/{namespace}/podsecuritypolicyselfsubjectreviews?",
...
// End security.openshift.io/v1/PodSecurityPolicySelfSubjectReview

impl k8s_openapi::Resource for PodSecurityPolicySelfSubjectReview {
...
impl<'de> serde::Deserialize<'de> for PodSecurityPolicySelfSubjectReview {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = PodSecurityPolicySelfSubjectReview;
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_spec: Option<crate::api::security::v1::PodSecurityPolicySelfSubjectReviewSpec> = None;
                ...
                Ok(PodSecurityPolicySelfSubjectReview {
...
impl serde::Serialize for PodSecurityPolicySelfSubjectReview {
