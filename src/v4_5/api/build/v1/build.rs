// Generated from definition com.github.openshift.api.build.v1.Build
...
pub struct Build {
    ...
    pub status: Option<crate::api::build::v1::BuildStatus>,
}

// Begin build.openshift.io/v1/Build

// Generated from operation connectBuildOpenshiftIoV1PostNamespacedBuildConfigInstantiatebinary
...
impl Build {
    ...
    #[cfg(feature = "api")]
    pub fn connect_post_namespaced_build_config_instantiatebinary(
        name: &str,
        namespace: &str,
        optional: ConnectPostNamespacedBuildConfigInstantiatebinaryOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, k8s_openapi::RequestError> {
        let ConnectPostNamespacedBuildConfigInstantiatebinaryOptional {
            as_file,
        ...
        let __url = format!("/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}/instantiatebinary?",
        ...
        if let Some(as_file) = as_file {
            __query_pairs.append_pair("asFile", as_file);
        }
        if let Some(revision_author_email) = revision_author_email {
            __query_pairs.append_pair("revision.authorEmail", revision_author_email);
        }
        if let Some(revision_author_name) = revision_author_name {
            __query_pairs.append_pair("revision.authorName", revision_author_name);
        }
        if let Some(revision_commit) = revision_commit {
            __query_pairs.append_pair("revision.commit", revision_commit);
        }
        if let Some(revision_committer_email) = revision_committer_email {
            __query_pairs.append_pair("revision.committerEmail", revision_committer_email);
        }
        if let Some(revision_committer_name) = revision_committer_name {
            __query_pairs.append_pair("revision.committerName", revision_committer_name);
        }
        if let Some(revision_message) = revision_message {
            __query_pairs.append_pair("revision.message", revision_message);
        }
        let __url = __query_pairs.finish();

        let __request = http::Request::post(__url);
        let __body = vec![];
        __request.body(__body).map_err(k8s_openapi::RequestError::Http)
    }
}
...
pub struct ConnectPostNamespacedBuildConfigInstantiatebinaryOptional<'a> {
    ...
    pub revision_author_email: Option<&'a str>,
    /// revision.authorName of the source control user
    pub revision_author_name: Option<&'a str>,
    /// revision.commit is the value identifying a specific commit
    pub revision_commit: Option<&'a str>,
    /// revision.committerEmail of the source control user
    pub revision_committer_email: Option<&'a str>,
    /// revision.committerName of the source control user
    pub revision_committer_name: Option<&'a str>,
    /// revision.message is the description of a specific commit
    pub revision_message: Option<&'a str>,
}

// Generated from operation connectBuildOpenshiftIoV1PostNamespacedBuildConfigWebhooks
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn connect_post_namespaced_build_config_webhooks(
        name: &str,
        namespace: &str,
        optional: ConnectPostNamespacedBuildConfigWebhooksOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, k8s_openapi::RequestError> {
        let ConnectPostNamespacedBuildConfigWebhooksOptional {
            path,
        } = optional;
        let __url = format!("/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks?",
            name = k8s_openapi::percent_encoding::percent_encode(name.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = k8s_openapi::percent_encoding::percent_encode(namespace.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
        let mut __query_pairs = k8s_openapi::url::form_urlencoded::Serializer::new(__url);
...
#[cfg(feature = "api")]
#[derive(Clone, Copy, Debug, Default)]
pub struct ConnectPostNamespacedBuildConfigWebhooksOptional<'a> {
    /// Path is the URL path to use for the current proxy request to pod.
    pub path: Option<&'a str>,
}

// Generated from operation connectBuildOpenshiftIoV1PostNamespacedBuildConfigWebhooksWithPath
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn connect_post_namespaced_build_config_webhooks_with_path(
        name: &str,
        namespace: &str,
        path: &str,
        optional: ConnectPostNamespacedBuildConfigWebhooksWithPathOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, k8s_openapi::RequestError> {
        let ConnectPostNamespacedBuildConfigWebhooksWithPathOptional {
            path_,
        } = optional;
        let __url = format!("/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks/{path}?",
            name = k8s_openapi::percent_encoding::percent_encode(name.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = k8s_openapi::percent_encoding::percent_encode(namespace.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            path = k8s_openapi::percent_encoding::percent_encode(path.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
        let mut __query_pairs = k8s_openapi::url::form_urlencoded::Serializer::new(__url);
...
// Generated from operation createBuildOpenshiftIoV1NamespacedBuild
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn create_namespaced_build(
        namespace: &str,
        body: &crate::api::build::v1::Build,
        ...
        let __url = format!("/apis/build.openshift.io/v1/namespaces/{namespace}/builds?",
            namespace = k8s_openapi::percent_encoding::percent_encode(namespace.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
        let mut __query_pairs = k8s_openapi::url::form_urlencoded::Serializer::new(__url);
...
// Generated from operation deleteBuildOpenshiftIoV1CollectionNamespacedBuild
...
impl Build {
    ...
    #[cfg(feature = "api")]
    pub fn delete_collection_namespaced_build(
        namespace: &str,
...
// Generated from operation deleteBuildOpenshiftIoV1NamespacedBuild
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn delete_namespaced_build(
        name: &str,
        namespace: &str,
        ...
        let __url = format!("/apis/build.openshift.io/v1/namespaces/{namespace}/builds/{name}",
            name = k8s_openapi::percent_encoding::percent_encode(name.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = k8s_openapi::percent_encoding::percent_encode(namespace.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
// Generated from operation listBuildOpenshiftIoV1BuildForAllNamespaces
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn list_build_for_all_namespaces(
        ...
        let __url = "/apis/build.openshift.io/v1/builds?".to_owned();
        let mut __query_pairs = k8s_openapi::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
// Generated from operation listBuildOpenshiftIoV1NamespacedBuild
...
// Generated from operation patchBuildOpenshiftIoV1NamespacedBuild
...
// Generated from operation readBuildOpenshiftIoV1NamespacedBuild

impl Build {
    /// read the specified Build
    ///
    /// Use the returned [`k8s_openapi::ResponseBody`]`<`[`ReadNamespacedBuildResponse`]`>` constructor, or [`ReadNamespacedBuildResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn read_namespaced_build(
        name: &str,
        namespace: &str,
        optional: ReadNamespacedBuildOptional<'_>,
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadNamespacedBuildResponse>), k8s_openapi::RequestError> {
        let ReadNamespacedBuildOptional {
            exact,
            export,
            pretty,
        } = optional;
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadNamespacedBuildResponse {
    Ok(crate::api::build::v1::Build),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadNamespacedBuildResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), k8s_openapi::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((ReadNamespacedBuildResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadNamespacedBuildResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceBuildOpenshiftIoV1NamespacedBuild
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn replace_namespaced_build(
        name: &str,
        namespace: &str,
        body: &crate::api::build::v1::Build,
...
// Generated from operation replaceBuildOpenshiftIoV1NamespacedBuildDetails
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn replace_namespaced_build_details(
        name: &str,
        namespace: &str,
        body: &crate::api::build::v1::Build,
        optional: k8s_openapi::ReplaceOptional<'_>,
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<k8s_openapi::ReplaceResponse<Self>>), k8s_openapi::RequestError> {
        let __url = format!("/apis/build.openshift.io/v1/namespaces/{namespace}/builds/{name}/details?",
            name = k8s_openapi::percent_encoding::percent_encode(name.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = k8s_openapi::percent_encoding::percent_encode(namespace.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
        let mut __query_pairs = k8s_openapi::url::form_urlencoded::Serializer::new(__url);
...
// Generated from operation watchBuildOpenshiftIoV1BuildForAllNamespaces
...
impl Build {
    ...
    ///     Optional parameters. Use `Default::default()` to not pass any.
    #[cfg(feature = "api")]
    pub fn watch_build_for_all_namespaces(
...
// Generated from operation watchBuildOpenshiftIoV1NamespacedBuild
...
// End build.openshift.io/v1/Build

impl k8s_openapi::Resource for Build {
...
impl k8s_openapi::ListableResource for Build {
    const LIST_KIND: &'static str = concat!("Build", "List");
}
...
impl<'de> serde::Deserialize<'de> for Build {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::build::v1::BuildSpec> = None;
                let mut value_status: Option<crate::api::build::v1::BuildStatus> = None;
...
impl serde::Serialize for Build {
