// Generated from definition com.github.openshift.api.route.v1.RouteIngressCondition
...
impl<'de> serde::Deserialize<'de> for RouteIngressCondition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = RouteIngressCondition;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("RouteIngressCondition")
            }
...
impl serde::Serialize for RouteIngressCondition {
