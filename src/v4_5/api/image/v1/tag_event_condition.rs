// Generated from definition com.github.openshift.api.image.v1.TagEventCondition
...
impl<'de> serde::Deserialize<'de> for TagEventCondition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = TagEventCondition;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("TagEventCondition")
            }
...
impl serde::Serialize for TagEventCondition {
