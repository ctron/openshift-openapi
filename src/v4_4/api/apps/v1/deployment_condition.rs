// Generated from definition com.github.openshift.api.apps.v1.DeploymentCondition
...
pub struct DeploymentCondition {
    ...
    pub last_update_time: Option<k8s_openapi::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_last_update_time: Option<k8s_openapi::apimachinery::pkg::apis::meta::v1::Time> = None;
