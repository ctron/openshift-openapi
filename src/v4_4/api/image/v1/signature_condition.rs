// Generated from definition com.github.openshift.api.image.v1.SignatureCondition

/// SignatureCondition describes an image signature condition of particular kind at particular probe time.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct SignatureCondition {
    /// Last time the condition was checked.
    pub last_probe_time: Option<k8s_openapi::apimachinery::pkg::apis::meta::v1::Time>,
...
impl<'de> serde::Deserialize<'de> for SignatureCondition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = SignatureCondition;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("SignatureCondition")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_last_probe_time: Option<k8s_openapi::apimachinery::pkg::apis::meta::v1::Time> = None;
...
impl serde::Serialize for SignatureCondition {
