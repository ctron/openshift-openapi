// Generated from definition com.github.openshift.api.project.v1.Project
...
pub struct Project {
    ...
    pub spec: Option<crate::api::project::v1::ProjectSpec>,

    /// Status describes the current status of a Namespace
    pub status: Option<crate::api::project::v1::ProjectStatus>,
}

// Begin project.openshift.io/v1/Project

// Generated from operation createProjectOpenshiftIoV1Project
...
impl Project {
    ...
    pub fn create_project(
        body: &crate::api::project::v1::Project,
        ...
        let __url = "/apis/project.openshift.io/v1/projects?".to_owned();
...
// Generated from operation deleteProjectOpenshiftIoV1Project
...
impl Project {
    ...
    pub fn delete_project(
        ...
        let __url = format!("/apis/project.openshift.io/v1/projects/{name}",
...
// Generated from operation listProjectOpenshiftIoV1Project
...
// Generated from operation patchProjectOpenshiftIoV1Project
...
// Generated from operation readProjectOpenshiftIoV1Project
...
impl Project {
    ...
    pub fn read_project(
        name: &str,
        optional: ReadProjectOptional<'_>,
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadProjectResponse>), k8s_openapi::RequestError> {
        let ReadProjectOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/project.openshift.io/v1/projects/{name}?",
            name = k8s_openapi::percent_encoding::percent_encode(name.as_bytes(), k8s_openapi::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
...
pub struct ReadProjectOptional<'a> {
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadProjectResponse {
    Ok(crate::api::project::v1::Project),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadProjectResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), k8s_openapi::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((ReadProjectResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadProjectResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceProjectOpenshiftIoV1Project
...
// Generated from operation watchProjectOpenshiftIoV1Project
...
// End project.openshift.io/v1/Project
...
impl k8s_openapi::ListableResource for Project {
    const LIST_KIND: &'static str = concat!("Project", "List");
}

impl k8s_openapi::Metadata for Project {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::project::v1::ProjectSpec> = None;
                let mut value_status: Option<crate::api::project::v1::ProjectStatus> = None;
