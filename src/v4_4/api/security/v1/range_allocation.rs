// Generated from definition com.github.openshift.api.security.v1.RangeAllocation
...
// Begin security.openshift.io/v1/RangeAllocation

// Generated from operation createSecurityOpenshiftIoV1RangeAllocation
...
impl RangeAllocation {
    ...
    pub fn create_range_allocation(
        body: &crate::api::security::v1::RangeAllocation,
        ...
        let __url = "/apis/security.openshift.io/v1/rangeallocations?".to_owned();
...
// Generated from operation deleteSecurityOpenshiftIoV1CollectionRangeAllocation
...
// Generated from operation deleteSecurityOpenshiftIoV1RangeAllocation
...
impl RangeAllocation {
    ...
    pub fn delete_range_allocation(
        ...
        let __url = format!("/apis/security.openshift.io/v1/rangeallocations/{name}",
...
// Generated from operation listSecurityOpenshiftIoV1RangeAllocation
...
// Generated from operation patchSecurityOpenshiftIoV1RangeAllocation
...
// Generated from operation readSecurityOpenshiftIoV1RangeAllocation
...
impl RangeAllocation {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadRangeAllocationResponse>), k8s_openapi::RequestError> {
        let ReadRangeAllocationOptional {
            exact,
            export,
            pretty,
        } = optional;
...
pub struct ReadRangeAllocationOptional<'a> {
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadRangeAllocationResponse {
    Ok(crate::api::security::v1::RangeAllocation),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadRangeAllocationResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), k8s_openapi::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((ReadRangeAllocationResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadRangeAllocationResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceSecurityOpenshiftIoV1RangeAllocation
...
// Generated from operation watchSecurityOpenshiftIoV1RangeAllocation
...
// End security.openshift.io/v1/RangeAllocation

impl k8s_openapi::Resource for RangeAllocation {
...
impl k8s_openapi::ListableResource for RangeAllocation {
    const LIST_KIND: &'static str = concat!("RangeAllocation", "List");
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_data: Option<k8s_openapi::ByteString> = None;
                let mut value_metadata: Option<k8s_openapi::apimachinery::pkg::apis::meta::v1::ObjectMeta> = None;
                let mut value_range: Option<String> = None;
