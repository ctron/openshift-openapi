// Generated from definition com.github.openshift.api.network.v1.ClusterNetwork
...
pub struct ClusterNetwork {
    ...
    pub cluster_networks: Vec<crate::api::network::v1::ClusterNetworkEntry>,
...
// Begin network.openshift.io/v1/ClusterNetwork

// Generated from operation createNetworkOpenshiftIoV1ClusterNetwork
...
impl ClusterNetwork {
    ...
    pub fn create_cluster_network(
        body: &crate::api::network::v1::ClusterNetwork,
        ...
        let __url = "/apis/network.openshift.io/v1/clusternetworks?".to_owned();
...
// Generated from operation deleteNetworkOpenshiftIoV1ClusterNetwork
...
impl ClusterNetwork {
    ...
    pub fn delete_cluster_network(
        ...
        let __url = format!("/apis/network.openshift.io/v1/clusternetworks/{name}",
...
// Generated from operation deleteNetworkOpenshiftIoV1CollectionClusterNetwork
...
// Generated from operation listNetworkOpenshiftIoV1ClusterNetwork
...
// Generated from operation patchNetworkOpenshiftIoV1ClusterNetwork
...
// Generated from operation readNetworkOpenshiftIoV1ClusterNetwork
...
impl ClusterNetwork {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadClusterNetworkResponse>), k8s_openapi::RequestError> {
        let ReadClusterNetworkOptional {
            exact,
            export,
            pretty,
        } = optional;
...
pub struct ReadClusterNetworkOptional<'a> {
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadClusterNetworkResponse {
    Ok(crate::api::network::v1::ClusterNetwork),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadClusterNetworkResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), k8s_openapi::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                ...
                Ok((ReadClusterNetworkResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadClusterNetworkResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceNetworkOpenshiftIoV1ClusterNetwork
...
// Generated from operation watchNetworkOpenshiftIoV1ClusterNetwork
...
// End network.openshift.io/v1/ClusterNetwork

impl k8s_openapi::Resource for ClusterNetwork {
...
impl k8s_openapi::ListableResource for ClusterNetwork {
    const LIST_KIND: &'static str = concat!("ClusterNetwork", "List");
}
...
impl<'de> serde::Deserialize<'de> for ClusterNetwork {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        #[allow(non_camel_case_types)]
        enum Field {
            Key_api_version,
            Key_kind,
            Key_cluster_networks,
            Key_hostsubnetlength,
            Key_metadata,
            Key_network,
            Key_plugin_name,
            Key_service_network,
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: serde::de::Error {
                        Ok(match v {
                            ...
                            "kind" => Field::Key_kind,
                            "clusterNetworks" => Field::Key_cluster_networks,
                            "hostsubnetlength" => Field::Key_hostsubnetlength,
                            "metadata" => Field::Key_metadata,
                            "network" => Field::Key_network,
                            "pluginName" => Field::Key_plugin_name,
                            "serviceNetwork" => Field::Key_service_network,
                            "vxlanPort" => Field::Key_vxlan_port,
                            _ => Field::Other,
                        })
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_cluster_networks: Option<Vec<crate::api::network::v1::ClusterNetworkEntry>> = None;
                let mut value_hostsubnetlength: Option<i64> = None;
                let mut value_metadata: Option<k8s_openapi::apimachinery::pkg::apis::meta::v1::ObjectMeta> = None;
                let mut value_network: Option<String> = None;
                let mut value_plugin_name: Option<String> = None;
                let mut value_service_network: Option<String> = None;
                let mut value_vxlan_port: Option<i64> = None;
                ...
                while let Some(key) = serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_vxlan_port => value_vxlan_port = serde::de::MapAccess::next_value(&mut map)?,
...
impl serde::Serialize for ClusterNetwork {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        serde::ser::SerializeStruct::serialize_field(&mut state, "clusterNetworks", &self.cluster_networks)?;
        ...
        if let Some(value) = &self.plugin_name {
            serde::ser::SerializeStruct::serialize_field(&mut state, "pluginName", value)?;
        }
        serde::ser::SerializeStruct::serialize_field(&mut state, "serviceNetwork", &self.service_network)?;
        if let Some(value) = &self.vxlan_port {
            serde::ser::SerializeStruct::serialize_field(&mut state, "vxlanPort", value)?;
        }
