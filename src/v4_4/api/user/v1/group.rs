...
impl Group {
    ...
    pub fn delete_group(
        ...
        let __url = format!("/apis/user.openshift.io/v1/groups/{name}",
...
impl Group {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadGroupResponse>), k8s_openapi::RequestError> {
