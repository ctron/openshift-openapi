...
impl ClusterRoleBinding {
    ...
    pub fn delete_cluster_role_binding(
        ...
        let __url = format!("/apis/authorization.openshift.io/v1/clusterrolebindings/{name}",
...
impl ClusterRoleBinding {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadClusterRoleBindingResponse>), k8s_openapi::RequestError> {
