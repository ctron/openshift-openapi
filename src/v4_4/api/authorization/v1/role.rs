// Generated from definition com.github.openshift.api.authorization.v1.Role
...
// Begin authorization.openshift.io/v1/Role

// Generated from operation createAuthorizationOpenshiftIoV1NamespacedRole
...
impl Role {
    ...
    pub fn create_namespaced_role(
        namespace: &str,
        body: &crate::api::authorization::v1::Role,
        ...
        let __url = format!("/apis/authorization.openshift.io/v1/namespaces/{namespace}/roles?",
...
// Generated from operation deleteAuthorizationOpenshiftIoV1NamespacedRole
...
impl Role {
    ...
    pub fn delete_namespaced_role(
        ...
        let __url = format!("/apis/authorization.openshift.io/v1/namespaces/{namespace}/roles/{name}",
...
// Generated from operation listAuthorizationOpenshiftIoV1NamespacedRole
...
// Generated from operation listAuthorizationOpenshiftIoV1RoleForAllNamespaces
...
impl Role {
    ...
    pub fn list_role_for_all_namespaces(
        ...
        let __url = "/apis/authorization.openshift.io/v1/roles?".to_owned();
        let mut __query_pairs = k8s_openapi::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
// Generated from operation patchAuthorizationOpenshiftIoV1NamespacedRole
...
// Generated from operation readAuthorizationOpenshiftIoV1NamespacedRole

impl Role {
    /// read the specified Role
    ///
    /// Use the returned [`k8s_openapi::ResponseBody`]`<`[`ReadNamespacedRoleResponse`]`>` constructor, or [`ReadNamespacedRoleResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> k8s_openapi::ResponseBody<ReadNamespacedRoleResponse>), k8s_openapi::RequestError> {
...
pub enum ReadNamespacedRoleResponse {
    Ok(crate::api::authorization::v1::Role),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}

#[cfg(feature = "api")]
impl k8s_openapi::Response for ReadNamespacedRoleResponse {
...
// Generated from operation replaceAuthorizationOpenshiftIoV1NamespacedRole
...
// Generated from operation watchAuthorizationOpenshiftIoV1NamespacedRole
...
// Generated from operation watchAuthorizationOpenshiftIoV1RoleForAllNamespaces
...
// End authorization.openshift.io/v1/Role

impl k8s_openapi::Resource for Role {
...
impl k8s_openapi::ListableResource for Role {
